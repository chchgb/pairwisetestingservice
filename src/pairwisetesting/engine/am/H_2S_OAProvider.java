...
public class H_2S_OAProvider implements IOAProvider {
	...
	/* 
	 * @param numOfFactors the number of factors and it should be 2^s - 1
	 * @see pairwisetesting.engine.am.IOAProvider#get(int)
	 */
	public int[][] get(int numOfFactors) {
		// Remove the all 1 column (happen to be the first column)
		int[][] res = getH2s(numOfFactors + 1).to2DArray(2);
	...
	/**
	 * @param numOfColumns the number of columns and it should be 2^s
	 * @return H2^s Matrix
	 */
