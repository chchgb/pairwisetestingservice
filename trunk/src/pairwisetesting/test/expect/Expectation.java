...
public class Expectation {
	...
	static {
		ExpectedResults.put("pairwisetesting.test.math.Range.isBetween_3_1_4", "true");
		ExpectedResults.put("pairwisetesting.test.math.Range.isBetween_3_3_4", "true");
		ExpectedResults.put("pairwisetesting.test.math.Range.isBetween_4_3_4", "true");
		ExpectedResults.put("pairwisetesting.test.math.Range.isBetween_4_3_4", "true");
		ExpectedResults.put("pairwisetesting.test.bookstore.BookStore.computeDiscountedPrice_1_NORMAL_C001", "85");
		ExpectedResults.put("pairwisetesting.test.bookstore.BookStore.computeDiscountedPrice_1_STUDENT_C002", "60");
		ExpectedResults.put("pairwisetesting.test.bookstore.BookStore.computeDiscountedPrice_1_INTERNAL_C003", "40");
		ExpectedResults.put("pairwisetesting.test.bookstore.BookStore.computeDiscountedPrice_2_NORMAL_C002", "70");
		ExpectedResults.put("pairwisetesting.test.bookstore.BookStore.computeDiscountedPrice_2_STUDENT_C003", "50");
		ExpectedResults.put("pairwisetesting.test.bookstore.BookStore.computeDiscountedPrice_2_INTERNAL_C001", "55");
