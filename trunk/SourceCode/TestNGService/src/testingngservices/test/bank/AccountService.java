...
public class AccountService {
	...
	public void transfer2(Account accountA, Account accountB, double amount) {
		manager.beginTransaction();
		this.withdraw(accountA.getId(), amount);
		double newBalanceB = this.deposit(accountB.getId(), amount);
		manager.commit();
	}
