 ...
 public class Dump {
    ...
    public static void main(String[] args) throws Exception {
		//StringTemplateGroup templates = new StringTemplateGroup(new FileReader("Java.stg"), AngleBracketTemplateLexer.class);
		
		StringTemplateGroup templates = new StringTemplateGroup(new FileReader("XML.stg"), DefaultTemplateLexer.class);
